...
using Input = GoogleARCore.InstantPreviewInput;
	...
	/// </summary>
	public class ControllerArAug2 : MonoBehaviour
	{
    ...
    public Text xcenter1;
    public Text ycenter1;
    public Text xdestination1;
    public Text ydestination1;
    public Text turnangle1;
		...
		if (ButtonClicked && !onetime && clearedALL ) {
				...
				if (Frame.Raycast ((float)Screen.width/2,(float)Screen.height/2, raycastFilter, out hit)) {   
                    ...
                    else if (count == 2)
                    {
                        ...
                        Quaternion turnangletarget1 = Quaternion.Euler(0, 0, 180);
                        targetObject4.transform.rotation = Quaternion.Slerp(hitone1, turnangletarget1, 1.0f);
                    ...
                    if (onetime) {
                        ...
                        float turnangle = turnanglerad * Mathf.Rad2Deg;
